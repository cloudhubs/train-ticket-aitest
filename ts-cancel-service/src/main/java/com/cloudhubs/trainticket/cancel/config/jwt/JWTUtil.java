package com.cloudhubs.trainticket.cancel.config.jwt;

import com.cloudhubs.trainticket.cancel.exception.TokenException;
    ...
    public static Authentication getJWTAuthentication(ServletRequest request) {
        ...
        if (token != null && validateToken(token)) {
            UserDetails userDetails = new UserDetails() {
                ...
                @Override
                public String getUsername() { return getUserName(token); }
                @Override
