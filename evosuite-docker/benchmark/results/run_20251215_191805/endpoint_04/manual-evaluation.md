...
- **Endpoint ID**: 4
- **Service**: ts-delivery-service
- **Method**: POST
- **Path**: /api/v1/inside_pay_service/inside_payment/account
- **Controller**: com.cloudhubs.trainticket.delivery.controller.InsidePaymentController
